...
const SearchBar = ({ cartCount }: Props) => {
     ...
     return (
          <div className="flex h-10 items-center pl-2 py-1 md:pl-0 md:justify-center bg-[#171717] text-white shadow-xl border-b border-gray-600">
               <form
                    className="flex mx-1 w-full md:w-[25rem] lg:w-[30rem] divide-x-[1px] divide-gray-600 border rounded-lg shadow-lg"
                    onSubmit={handleSearch}
               >
                    <input
                         className="flex-1 rounded-tl-lg rounded-bl-lg shadow-inner focus:outline-none text-black pl-2"
                         type="text"
                    />
                    <button
